...
\end{align*}
$$
And that last line *is* the Fourier Transform. It is convention to capitalize the name of the function you're Fourier Transforming. The notation you'll often see in literature is:
$$
S(w) = ℱ[s(t)]
$$
