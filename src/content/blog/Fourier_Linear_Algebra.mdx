---
title: "The Fourier Series: A Linear Algebra Approach"
description: "Fourier analysis with linear algebra"
pubDate: "Oct 16 2025"
heroImage: "../../assets/3b1b_clickbait.jpg"
hidden: true
---
...
$$
So the criterion is that the functions in $$L^2$$ have finite length. In signal analysis, this length has another interpretation. It's proportional to the energy of a signal:

$$
E \propto \int_0^T s(t)^2 dt = \langle s(t),s(t) \rangle
$$
Luckily, in the real world, a signal cannot have infinte energy, and thus almost all real world signals fall into the $L^2$ vector space.
...
\newline
c_k &= \frac{1}{T}\int_T s(t) e^{-2\pi i k t} dt
\end{align*}
$$
